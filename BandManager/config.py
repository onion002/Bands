...
class Config:
    ...
    CORS_ORIGINS = [
        ...
        "http://192.168.3.176:5173",   # 局域网开发环境
        "http://192.168.3.176",        # 局域网开发环境（无端口）
    ]
    
    # 开发环境允许的IP段（支持通配符）
    CORS_IP_PATTERNS = [
        "http://192.168.*.*:5173",     # 192.168.x.x:5173
        "http://192.168.*.*",          # 192.168.x.x
        "http://10.*.*.*:5173",        # 10.x.x.x:5173
        "http://10.*.*.*",             # 10.x.x.x
        "http://172.16.*.*:5173",      # 172.16.x.x:5173
        "http://172.16.*.*",           # 172.16.x.x
    ]
